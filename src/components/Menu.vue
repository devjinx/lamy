...
.Menu {
  ...
  height: 100%;
  background-color: #D7DBDD; /* Changed to white background */
  padding: 20px;
...
.Menu ul li.active a {
  background-color: #3498db; /* Blue background for active item */
  color: #fff; /* White text for active item */
}

.Menu ul li .lamy-link {
  font-size: 24px;
  font-weight: bold;
}

.Menu ul li .lamy-link .lamy-logo {
  margin-bottom: 5px;
  margin-right: 10px;
}
